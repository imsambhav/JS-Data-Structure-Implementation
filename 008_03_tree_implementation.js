...
tree.add("dev3", "cto");
tree.add("cfo", "ceo");
tree.add("accountatnt", "cfo");
tree.add("cmo", "ceo");

tree.print(); // ceo | cto cfo cmo | dev1 dev2 dev3 accountatnt
tree.printByLevel();
// ceo
// cto cfo cmo
// dev1 dev2 dev3 accountatnt

tree.contains("dev1"); // true
...
tree.remove("cmo");
tree.print(); // => ceo | cto cfo | dev1 dev2 dev3 accountatnt
