// Adjacency list representation (Wikipedia Graph)
// 6 --> 4 --> (5)(3)--> 2 --> 1
...
Graph.prototype.removeEdge = function(vertex1, vertex2) {
  ...
  var index2 = this.edges[vertex2] ? this.edges[vertex2].indexOf(vertex2) : -1;
...
graph.pathFromTo(6, 1); // 6-4-5-1
graph.pathFromTo(3, 5); // 3-2-5
...
graph.pathFromTo(6, 1); // 6-4-3-2-1
